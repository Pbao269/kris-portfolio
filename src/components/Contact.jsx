...
const socialLinks = [
    ...
    {
      href: 'https://www.linkedin.com/in/kris-to2609',
      icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      href: 'https://www.instagram.com/tgpbao',
    ...
    <section id="contact" className="section">
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
            <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                ...
                <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-2-[30ch] reveal-up">
            ...
            <form action="https://getform.io/f/avrrwkoa" method="POST" className="xl:pl-10 2xl:pl-20">
                <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                    ...
                    <div className="mb-4">
                        ...
                        autoComplete="email" required placeholder="phuocbao.work@gmail.com" className="text-field reveal-up" />
                    </div>
                </div>
                ...
                <div className="mb-4">
                    ...
                    <textarea name="message" id="message" placeholder="Hi!" required 
